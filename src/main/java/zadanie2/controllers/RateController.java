...
public class RateController {
	...
	@ResponseBody
	public String saveRateDto(@RequestBody RateDto rateDto) throws DaoException {
		return rateService.save(rateDto).toString();
	}

	@RequestMapping(method = RequestMethod.PUT, value = "/{rateId}")
	@ResponseBody
	public String updateRateDto(@RequestBody RateDto rateDto, @PathVariable long rateId) throws DaoException {
